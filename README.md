...
🛠️ Skill Banane ka Process (Manual Step-by-Step)
...
Verify: Claude ko terminal mein kahen ccr list skills (agar command support ho) ya sirf sawal puchein taake wo use "Discover" kare.
